        ...
        <View style={styles.main}>
          <ScrollView style={styles.scrol}>
            <View style={styles.buttons}>
              ...
              <Buttom title='Card' icon='' size={20} color='#E5E4E4' textColor='#FF1577' width={'85%'} heigth={65} marginTop={'7%'} border={32} just={'center'} aling={''} function={card} padding={15}/>
              ...
              <Buttom title='Investments' icon='' size={20} color='#E5E4E4' textColor='#FF1577' width={'85%'} heigth={65} marginTop={'7%'} border={32} just={'center'} aling={''} function={investments} padding={15}/>
            </View>
          </ScrollView>
        </View>
    </View>
