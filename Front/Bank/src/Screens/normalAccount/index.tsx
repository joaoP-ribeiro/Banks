        ...
        <View style={styles.page}>
            ...
            <Title title='Normal Account' size={30} textColor='#000' marginTop={'5%'}/>
                <ScrollView>
                    ...
                    <Input title='Birthdate' marginTop={'5%'} width={'80%'} type={'numeric'} size={20} limit={14} passowrd={false} onReturn={returnValue}/>
                    <Input title='CPF' marginTop={'5%'} width={'80%'} type={'numeric'} size={20} limit={14} passowrd={false} onReturn={returnValue}/>
                    <Input title='RG' marginTop={'5%'} width={'80%'} type={'numeric'} size={20} limit={14} passowrd={false} onReturn={returnValue}/>
